    ...
    return (
        <div className="afc-devmode-bar">
            ...
            <div className="afc-devmode-actions">
                <button className="afc-devmode-btn" onClick={onSave} title="Save (Ctrl+S)">
                    Save
                </button>
                <button className="afc-devmode-btn afc-devmode-btn-done" onClick={onToggle} title="Done editing (Ctrl+Shift+E)">
                    Done
                </button>
            </div>
        </div>
