...
export const BlockRenderer: React.FC<BlockRendererProps> = ({
    ...
    return (
        <div
            className={`afc-block afc-block-${blockType} ${focused ? 'afc-focused' : ''}`}
        ...
        >
            ...
            {embeddedNode?.metadata.lockState && (
                <div className="afc-block-locked" title={`Locked by ${embeddedNode.metadata.lockState.lockedBy}`}>
                    🔒
                </div>
            )}
            ...
            {Tag === 'h1' || Tag === 'h2' || Tag === 'h3' || Tag === 'h4' || Tag === 'h5' || Tag === 'h6' ? (
                ...
                <pre className="afc-code-block">
                    <code
                        ...
                        onInput={handleInput}
                        onFocus={handleFocus}
                        className={`afc-block-content language-${element.getAttribute('language') || 'text'}`}
                    >
                        {text}
                    </code>
                </pre>
                ...
                React.createElement(
                    Tag,
                    {
                        ...
                        onClick: handleClick,
                        className: 'afc-block-content',
                        'data-placeholder': blockType === 'paragraph' ? 'Type something...' : '',
                    },
                    text,
                )
            )}
            ...
            {embeddedNode && embeddedNode.classification.confidence > 0.5 && (
                <div
                    ...
                    title={`Sentiment: ${embeddedNode.classification.sentiment.toFixed(2)}`}
                    aria-hidden="true"
                />
            )}
        </div>
...
type BlockTag = 'p' | 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'blockquote' | 'li' | 'pre' | 'div' | 'hr';
