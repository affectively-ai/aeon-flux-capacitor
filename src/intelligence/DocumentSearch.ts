...
export class DocumentSearch {
    private config: Required<Omit<SearchConfig, 'embedQuery'>> & Pick<SearchConfig, 'embedQuery'>;
    ...
    async search(
        ...
        const results: SearchResult[] = candidates
            .map((block) => {
                // Semantic score
                const semanticScore = this.cosineSimilarity(queryEmbedding, block.embedding);
