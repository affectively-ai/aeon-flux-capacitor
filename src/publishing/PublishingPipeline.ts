...
export class PublishingPipeline {
    ...
    createDraft(params: {
        ...
        const record: PublishRecord = {
            ...
            socialCards: this.generateSocialCards(params.title, excerpt, params.coverImage),
    ...
    transition(
        ...
        const updated: PublishRecord = {
            ...
            state: to,
            updatedAt: new Date().toISOString(),
            publishedAt: to === 'published' ? new Date().toISOString() : record.publishedAt,
    ...
    setProjections(recordId: string, projections: PublishProjection[]): void {
        ...
        const updated = { ...record, projections, updatedAt: new Date().toISOString() };
        this.records.set(recordId, updated);
    }
